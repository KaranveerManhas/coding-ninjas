...
def diameterHelper(root):
    ...
    diametermax = max(leftdiameter, rightdiameter, diameterfromRoot)

    height = 1 + max(leftpair.height, rightpair.height)

    return Pair(diametermax, height)


def diameterOfBinaryTree(root) :
    # Your code goes here
    pai = diameterHelper(root)
